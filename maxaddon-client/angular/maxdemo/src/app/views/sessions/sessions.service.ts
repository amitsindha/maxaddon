...
export class SessionService {
  ...
  removeItem(id): Observable<any> {
    ...
    return this.http.delete(environment.apiURL+'/api/auth/signout'+id, {headers: headers});      
  } 
  ...
  logIn(item): Observable<any> {
    ...
    return this.http.post(environment.apiURL+'/api/auth/signin', item, {headers: headers});    
  } 
  ...
  signup(item): Observable<any> {
    ...
    return this.http.post(environment.apiURL+'/api/auth/signup', item, {headers: headers});    
  } 
  ...
  logOut(): Observable<any> {
    ...
    return this.http.post(environment.apiURL+'/api/auth/signout?access_token='+accessToken, null, {headers: headers});    
  } 
