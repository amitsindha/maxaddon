...
export class ClustersService {
  ...
  addItem(item): Observable<any> {
    ...
    return this.http.post(environment.apiURL+'/rest/api/cluster/create', item, {headers: headers});    
  } 
  ...
  updateItem(id, item): Observable<any> {
    ...
    return this.http.put(environment.apiURL+'/rest/api/cluster/'+id+'/edit', item, {headers: headers});    
  } 
  ...
  removeItem(id): Observable<any> {
    ...
    return this.http.delete(environment.apiURL+'/rest/api/cluster/'+id+'/delete', {headers: headers});    
  } 
