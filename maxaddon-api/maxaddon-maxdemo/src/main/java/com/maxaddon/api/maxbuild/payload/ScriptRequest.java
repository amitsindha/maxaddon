...
public class ScriptRequest {
    ...
    private List<ScriptEventRequest> scriptEventRequest;
    ...
    public List<ScriptEventRequest> getScriptEventRequest() {
        return scriptEventRequest;
    }

    public void setScriptEventRequest(List<ScriptEventRequest> scriptEventRequest) {
        this.scriptEventRequest = scriptEventRequest;
    }
